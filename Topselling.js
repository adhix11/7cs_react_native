...
export default class TopsellingScreen extends Component {
...
setModalVisible(visible, img) {
 ...
 _onRefresh() {
    ...
    let url = 'http://45.76.35.84/api/top_selling.php';
    console.log(url);
    fetch(url, {
         method: 'GET'
      })
            ...
            renderRow = {
                    (rowData) => <View style={{marginHorizontal: 10, marginTop:20, padding: 10, paddingTop: 20, backgroundColor: '#fff'}}>
                                   ...
                                   <View style={{flexDirection: 'row', margin: 10}}>
                                    ...
                                    </View><Text style={{alignSelf: 'stretch', marginHorizontal:10, color: 'rgb(30,75,113)'}}>Remarks: {rowData.remarks} </Text>
